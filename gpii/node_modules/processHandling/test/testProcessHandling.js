...
var alwaysExistingProcess = "explorer.exe"
...
jqUnit.test("Testing findProcessByName", function () {
    ...
    pid = gpii.windows.findProcessByName(alwaysExistingProcess);
...
jqUnit.asyncTest("Testing timeout waiting for processes termination", function () {
    ...
    gpii.windows.waitForProcessTermination(alwaysExistingProcess, { timeout: 100 })
        .then(function () {
            jqUnit.fail("The process '" + alwaysExistingProcess + "' should not have terminated");
        }, function () {
            jqUnit.assert("Should have timed out");
            jqUnit.start();
        });
